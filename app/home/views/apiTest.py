...
@home.login_post("/apiTest/title", summary="获取卡片统计")
...
@home.login_post("/apiTest/hit", summary="统计记录的问题数量")
...
@home.login_post("/apiTest/project", summary="统计服务数")
...
@home.login_post("/apiTest/module", summary="统计模块数")
...
@home.login_post("/apiTest/api", summary="统计接口数")
...
@home.login_post("/apiTest/case", summary="统计用例数")
...
@home.login_post("/apiTest/report", summary="统计测试报告数")
