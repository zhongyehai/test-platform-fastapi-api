...
from ...baseForm import BaseForm, PaginationForm, AddUiElementDataForm
from ..model_factory import WebUiProject as Project, WebUiModule as Module, WebUiPage as Page, WebUiElement as Element, \
    WebUiCaseSuite as CaseSuite, WebUiCase as Case, WebUiStep as Step
...
class AddElementForm(BaseForm):
    ...
    async def validate_request(self, *args, **kwargs):
        ...
        await self.validate_data_is_exist("i项目不存在", Project, id=self.project_id)
