...
from ...baseForm import BaseForm, PaginationForm, AddCaseDataForm, VariablesModel, SkipIfModel, HeaderModel
...
class EditCaseForm(GetCaseForm):
    ...
    async def validate_request(self, *args, **kwargs):
        ...
        project_env = await ProjectEnv.filter(project_id=project.id).first()
