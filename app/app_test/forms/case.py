...
from ...baseForm import BaseForm, PaginationForm, AddCaseDataForm, SkipIfModel, VariablesModel
...
class AddCaseForm(BaseForm):
    ...
    case_list: List[AddCaseDataForm] = Field(..., title="用例数据")
...
class RunCaseForm(BaseForm):
    ...
    async def validate_request(self, *args, **kwargs):
        ...
        return {"case_list": case_list, "server": server, "phone": phone}
